...
##############################################
# USAGE: sbatch --job-name=SCENIC_multirun_test --cpus-per-task=4 --mem-per-cpu=4G --array=1-5%5 SCENIC_multirun.sh $loom_in $tf_list $ranking $annotation $method $out_name
# Date 02/17/2022
##############################################
